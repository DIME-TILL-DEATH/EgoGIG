...
TUsbTask::TUsbTask (const char* name , const int stack_size , const int priority ) : TTask(name , stack_size , priority , false)
{
...
void TUsbTask::Code()
{
      ...
      usb_msc_init(msc_dev, 0x82, 64, 0x01, 64, "VendorID", "ProductID",
		"0.00", sectors , read_block , write_block);
