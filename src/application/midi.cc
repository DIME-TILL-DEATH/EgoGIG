...
extern "C" void USART1_IRQHandler()
{
  ...
  case 0:
	  ...
	  if(us_buf == (0xb0 | ctrl_param[chann]))midi_buf = 0xb0;
	  if(us_buf == (0x90 | ctrl_param[chann]))midi_buf = 0x90;
	  if(us_buf == (0xc0 | ctrl_param[chann]))midi_buf = 0xc0;
	  break;
  case 0xb0:if(!ctrl_param[ctrl1_t] && ctrl_param[ctrl1] == us_buf)
  	        {
	  	  	   play_fl = 1;
  	           pause_fl= 0;
  		       play_fl2 = 1;
  	  	    ...
  	  	    midi_buf = 4;
  	  break;
  case 0x90:if(ctrl_param[ctrl1_t] && ctrl_param[ctrl1] == us_buf)
    	{
  	   	   play_fl = 1;
  	   	   pause_fl= 0;
  	   	   play_fl2 = 1;
