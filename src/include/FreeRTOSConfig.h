...
#define FREERTOS_CONFIG_H
        ...
        #define configCPU_CLOCK_HZ			( ( unsigned long ) HAL_RCC_GetSysClockFreq())
        ...
        #define configTIMER_TASK_STACK_DEPTH	( configMINIMAL_STACK_SIZE * 2 )
             ...
             #define configUSE_REENTRANT                1
        #else
             #define configUSE_REENTRANT                0
        #endif
...
//      #define xPortSysTickHandler SysTick_Handler
        ...
        //
            ...
            #define RUN_TIME_STATS_INTERRUPT_FREQUENCY                ( ( unsigned short ) 20000 )
            ...
            //#define portGET_RUN_TIME_MS(RUN_TIME) //1000*RUN_TIME/(portTickType)timerINTERRUPT_FREQUENCY
            ...
            //#define configUSE_TIMERS_JITTER  //0
        #endif
